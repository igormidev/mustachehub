...
void main() {
  test('Testing enums', () {
    const favoriteColor = 'dash';

    const input =
        // '{{variable.camelCase()}}';
        'Lets test some enums: {{#willDisplay.that()}}IsDisplayed{{/willDisplay.that()}}{{^willDisplay.that()}}IsNOTDisplayed{{/willDisplay.that()}}';
  ...
  //   const name = 'dash';
  //   const input =
  //       'hello {{name}}. {{#pessoa}}{{nome.camelCase()}}{{/pessoa}}  {{#times}}{{#camelCase}}{{.}}{{/camelCase}}{{/times}}';
  //   final result = input.render(<String, dynamic>{
  //     'name': name,
  //     'vado': {
