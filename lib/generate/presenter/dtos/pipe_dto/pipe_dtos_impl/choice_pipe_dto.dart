...
class ChoicePipeDto extends Equatable
    implements PipeDTO<ChoicePipe, ChoicePipeDTOPayload> {
  @override
  final String uuid;
  @override
  final ChoicePipe pipe;
  @override
  final ChoicePipeDTOPayload payloadValue;
  ...
  @override
  PipeDTO<ChoicePipe, ChoicePipeDTOPayload> copyWith({
    required ChoicePipeDTOPayload payloadValue,
  }) {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'uuid': uuid,
      'pipe': pipe.toMap(),
      'payloadValue': payloadValue.toMap(),
    };
  }
  ...
  factory ChoicePipeDto.fromMap(Map<String, dynamic> map) {
    return ChoicePipeDto(
      ...
      payloadValue: ChoicePipeDTOPayload.fromMap(
