  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(20),
        color: isFocused ? Colors.red : null,
        // color: isFocused ? Them.of(context).colorScheme.surfaceBright : null,
      ),
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: Theme.of(context).textTheme.titleSmall?.copyWith(
                            color: hardColor,
                            // color: switch (widget.option.declarationType) {
                            //   DeclarationType.scope =>
                            //     Theme.of(context).colorScheme.onPrimary,
                            //   DeclarationType.invertedScope =>
                      ...
                      boolean: (ChoosableVariableImplementationBoolean value) =>
                        ...
                        normalValue: (_) => TextSpan(
                          children: [
                            const TextSpan(
                              text:
                                  'Display content in scope when conditional ',
                            ),
                            TextSpan(
                              text: 'is',
                              style: style?.copyWith(
